...
const TestimonialV2 = ({ isDark, sectionClass }: DataType) => {
    return (
        <>
            <div className={`testimonial-style-one-area default-padding bg-gray bg-cover text-center ${sectionClass}`}>
